...
Implementation plan, revised 2026-09-17 while building it. **Status: in progress** — 526.1 (provider seam and Firecrawl adapter) and 526.2 (schema, entities, repository) are implemented. The ticket itself carries only Goal / Scope / Notes / Relationships — this document is the plan, and the issue body was deliberately left free of it.
