<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false>
    ...
    <div class="${properties.kcLoginClass!}">
        <#--  The HTML Display name from the UI of Keycloak  -->
        <#--    <div id="kc-header" class="${properties.kcHeaderClass!}" >-->
        <#--        <div id="kc-header-wrapper"-->
        <#--             class="${properties.kcHeaderWrapperClass!}">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</div>-->
        <#--    </div>-->
        <div class="${properties.kcFormCardClass!}">
            <#--        header Welcome to Gendox!-->
                                ...
                                <ul role="menu" tabindex="-1" aria-labelledby="kc-current-locale-link"
                                    ...
                                    <#list locale.supported as l>
                                        <li class="${properties.kcLocaleListItemClass!}" role="none">
                                            <a role="menuitem" id="language-${i}"
                                               class="${properties.kcLocaleItemClass!}" href="${l.url}">${l.label}</a>
                                        </li>
                                        <#assign i++>
                                    </#list>
                                </ul>
                    ...
                    <#if displayRequiredFields>
                        <div class="${properties.kcContentWrapperClass!}">
                            ...
                            <div class="logo-container">
                                <img src="${url.resourcesPath}/img/gendoxLogo.png" alt="Logo">
                            </div>
                            <div class="title-container">
                                <#--                                <h1 id="kc-page-title"><#nested "header"></h1>-->
                                <h1 id="kc-page-title">Create new account </h1>
                                <p class="subtitle">Register to Gendox and start the adventure</p>
<#--                                <div class="${properties.kcLabelWrapperClass!} subtitle-right">-->

<#--                                    <p><span class="required">*</span> ${msg("requiredFields")} </p>-->
<#--                                </div>-->
                            </div>
                    ...
                    <#else>
                        ...
                        <!-- Title -->
                        <div class="title-container">
                            <h1 id="kc-page-title">Welcome to Gendox! 👋🏻</h1>
                            <#--                            <h1 id="kc-page-title"><#nested "header"></h1>-->
