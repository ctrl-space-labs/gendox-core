...
SET
    ...
    section_chat_template_id = (SELECT id FROM gendox_core.templates WHERE name = 'Default Section Template' LIMIT 1),
    updated_at = NOW()
...
WHERE
    ...
    AND NOT EXISTS (
        ...
        WHERE agent_name = 'test-project-1_1 Agent'
          ...
          AND section_chat_template_id = (SELECT id FROM gendox_core.templates WHERE name = 'Default Section Template' LIMIT 1)
